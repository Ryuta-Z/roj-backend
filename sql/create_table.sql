...
(
    id
        ...
        primary
            key,
    language    varchar(128)                       null comment '语言',
...
) comment '用户提交' collate = utf8mb4_unicode_ci;
-- 帖子表
